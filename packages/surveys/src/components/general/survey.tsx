...
export function Survey({
  ...
  const sessionBlocks = useMemo(
    () => getBlocksWithShuffledPools(localSurvey.blocks),
    // Signature captures the membership/id changes that should reshuffle; block content edits must not.
    // eslint-disable-next-line react-hooks/exhaustive-deps -- keyed by sessionBlocksSignature
    [sessionBlocksSignature]
  );
